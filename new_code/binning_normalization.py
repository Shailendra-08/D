...
def write_to_file(file_name, original_data, mean_binned, boundaries_binned, zscore_data):
...
if __name__ == "__main__":
    ...
    if not data:
        ...
        write_to_file(output_file, data, mean_binned, boundaries_binned, zscore_data)